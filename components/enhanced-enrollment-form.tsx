              ...
              {!otpSent ? (
                <div className="space-y-6">
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-3 w-full bg-gradient-to-r from-green-500 to-green-600 p-1 rounded-2xl hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-xl"
                  >
                    <div className="flex items-center justify-center gap-2 px-4 py-3">
                      ...
                      <span className="text-white font-semibold">Contact on WhatsApp</span>
                    </div>
                  </a>
